...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2025 at 08:44 AM
...
--
-- Table structure for table `anggota_booking`
--

CREATE TABLE `anggota_booking` (
  `id_anggota` int NOT NULL COMMENT 'Primary key untuk tabel anggota booking',
...
CREATE TABLE `booking` (
  `id_booking` int NOT NULL COMMENT 'Primary key untuk tabel booking',
...
CREATE TABLE `feedback` (
  `id_feedback` int NOT NULL COMMENT 'Primary key untuk tabel feedback',
...
CREATE TABLE `hari_libur` (
  `id_hari_libur` int NOT NULL COMMENT 'Primary key untuk tabel hari libur',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Daftar tanggal libur/event khusus yang tidak bisa booking';
...
--
-- Table structure for table `pelanggaran_suspensi`
--

CREATE TABLE `pelanggaran_suspensi` (
  `id_suspend` int NOT NULL COMMENT 'Primary key untuk tabel pelanggaran dan suspensi',
...
--
-- Dumping data for table `pelanggaran_suspensi`
--
...
(9, '2407411032', 'Keterlambatan Check-in', 'Tidak hadir (2/3). Diblokir booking 24 jam.', '2025-12-17 12:41:30', '2025-12-18 12:41:30'),
(10, '2407411053', 'Keterlambatan Check-in', 'Tidak hadir (1/3). Diblokir booking 24 jam.', '2025-12-17 12:41:40', '2025-12-18 12:41:40');
...
CREATE TABLE `ruangan` (
  `id_ruangan` int NOT NULL COMMENT 'Primary key untuk tabel ruangan',
...
(11, 'Lentera Edukasi', 'Ruang Umum', 4, 2, 'R. Bimbingan & Konseling', '', 'Tersedia', NULL),
...
(13, 'R. Rapat Dosen', 'Ruang Rapat', 10, 3, 'Ruangan rapat khusus dosen.', 'Wajib reservasi.', 'Tersedia', NULL);
...
CREATE TABLE `schedule` (
  `id_schedule` int NOT NULL COMMENT 'Primary key untuk tabel schedule',
...
--
-- Table structure for table `waktu_operasi`
--

CREATE TABLE `waktu_operasi` (
  `id_waktu_operasi` int NOT NULL COMMENT 'Primary key untuk tabel waktu operasi',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Pengaturan jam operasional booking per hari dalam seminggu';
...
--
-- Indexes for table `anggota_booking`
--
ALTER TABLE `anggota_booking`
  ADD PRIMARY KEY (`id_anggota`),
  ADD KEY `fk_anggota_booking_booking` (`id_booking`),
  ADD KEY `fk_anggota_booking_akun` (`nomor_induk`);
...
ALTER TABLE `booking`
  ...
  ADD KEY `fk_booking_status` (`id_status_booking`);
...
ALTER TABLE `feedback`
  ...
  ADD KEY `fk_feedback_booking` (`id_booking`);
...
ALTER TABLE `hari_libur`
  ...
  ADD KEY `fk_hari_libur_akun` (`created_by`);

--
-- Indexes for table `pelanggaran_suspensi`
--
ALTER TABLE `pelanggaran_suspensi`
  ADD PRIMARY KEY (`id_suspend`),
  ADD KEY `fk_pelanggaran_akun` (`nomor_induk`);
...
ALTER TABLE `schedule`
  ...
  ADD KEY `fk_schedule_booking` (`id_booking`);
...
--
-- Indexes for table `waktu_operasi`
--
ALTER TABLE `waktu_operasi`
  ADD PRIMARY KEY (`id_waktu_operasi`),
  ADD UNIQUE KEY `unique_hari` (`hari`),
  ADD KEY `fk_waktu_operasi_akun` (`updated_by`);
...
--
-- AUTO_INCREMENT for table `anggota_booking`
--
ALTER TABLE `anggota_booking`
  MODIFY `id_anggota` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel anggota booking', AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `booking`
--
ALTER TABLE `booking`
  MODIFY `id_booking` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel booking', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `feedback`
--
ALTER TABLE `feedback`
  MODIFY `id_feedback` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel feedback', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `hari_libur`
--
ALTER TABLE `hari_libur`
  MODIFY `id_hari_libur` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel hari libur', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `pelanggaran_suspensi`
--
ALTER TABLE `pelanggaran_suspensi`
  MODIFY `id_suspend` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel pelanggaran dan suspensi', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `ruangan`
--
ALTER TABLE `ruangan`
  MODIFY `id_ruangan` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel ruangan', AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `schedule`
--
ALTER TABLE `schedule`
  MODIFY `id_schedule` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel schedule', AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `waktu_operasi`
--
ALTER TABLE `waktu_operasi`
  MODIFY `id_waktu_operasi` int NOT NULL AUTO_INCREMENT COMMENT 'Primary key untuk tabel waktu operasi', AUTO_INCREMENT=8;
...
--
-- Constraints for table `anggota_booking`
--
ALTER TABLE `anggota_booking`
...
--
-- Constraints for table `pelanggaran_suspensi`
--
ALTER TABLE `pelanggaran_suspensi`
...
--
-- Constraints for table `waktu_operasi`
--
ALTER TABLE `waktu_operasi`
